        ...
        <div class="shopper-informations">
            <div class="row">
                ...
                <div class="col-sm-5 clearfix">
                    <div class="bill-to">
                        <p>Bill To</p>
                        <div align="center" class="form-one">
                            <form name="form1" action="" method="post" align="center">
                                ...
                                <input type="text" placeholder="Real Address" name="resi" required>
                                <input type="text" placeholder="City" name="city" required pattern="[A-Za-z]+" title="please enter valid city name[a-z only]">
                                <input type="text" placeholder="Pincode" name="pincode" required pattern="[0-9](6)" title="please enter valid pincode[0-9 and 10 digit only]">
                                <input type="text" placeholder="Contact Number" name="cno" required pattern="[0-9](10)" title="please enter valid contact[0-9 and 10 digit only]" >
